...
const mockUsers = [
  {
    ...
    referralId: 'REF001',
    referencedBy: null,
    role: 'Admin', // Changed to single role
    createdAt: new Date('2023-01-15T10:00:00Z'),
    updatedAt: null,
    isActive: true, // Added isActive status
    phoneNumber: '+1-555-123-4567', // Added phone number
  },
  {
    id: 'user_002',
    ...
    referralId: 'REF002',
    referencedBy: 'REF001',
    role: 'User', // Changed to single role
    createdAt: new Date('2023-02-20T14:30:00Z'),
    updatedAt: null,
    isActive: true, // Added isActive status
    phoneNumber: '+1-555-234-5678', // Added phone number
  },
  {
    id: 'user_003',
    ...
    updatedAt: null,
    isActive: false, // Added isActive status, set to false for testing
    phoneNumber: '+1-555-345-6789', // Added phone number
  },
  {
    id: 'user_004',
    ...
    referralId: 'REF004',
    referencedBy: 'REF002',
    role: 'Viewer', // Changed to single role
    createdAt: new Date('2023-04-10T11:00:00Z'),
    updatedAt: null,
    isActive: true, // Added isActive status
    phoneNumber: '+1-555-456-7890', // Added phone number
  },
  {
    id: 'user_005',
    ...
    updatedAt: null,
    isActive: true, // Added isActive status
    phoneNumber: '+1-555-567-8901', // Added phone number
  },
  {
    id: 'user_006',
